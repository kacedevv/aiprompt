...
import { Wand2, Download, X, Share2, Maximize2, Minimize2, Copy, FileCode, MessageSquareQuote, Terminal, PenTool, Palette, BookOpen, Smartphone, Code2, MessageCircle, Sparkles } from 'lucide-react';
...
export const Workstation: React.FC<WorkstationProps> = ({ mode, lang, onAddToHistory, initialPrompt = '', onNavigate }) => {
  // Input State
  ...
  // REPLACED generic boolean with specific status string
    ...
    try {
      ...
      switch (mode) {
        case TabView.EDITOR:
          ...
          const finalPrompt = `${prompt}. Output aspect ratio: ${aspectRatio}.`;
                ...
                <div className="p-5 bg-[#0a0a0a] border border-zinc-800 rounded-sm hover:border-zinc-700 transition-colors">
                   <div className="mb-4">
                      ...
                      <input 
                         ...
                         placeholder={
                            pbState.category === 'ART' ? "A futuristic cyberpunk city..." :
                            pbState.category === 'CODE' ? "Python script to scrape data..." :
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      {/* ... (Existing logic for inputs, styling enhanced via generic classNames) ... */}
